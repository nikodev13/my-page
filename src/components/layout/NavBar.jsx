...
function NavBar() {
	...
	return (
		<nav className={`lg:sticky top-0 lg:flex lg:h-screen lg:flex-col text-white relative text-left bg-gray-800 lg:p-2`}>
			...
			<div className={`flex flex-col select-none border-y-2 lg:border-b-0 border-gray-600 bg-gray-800 gap-4 lg:h-full w-full p-4 lg:px-2 transition-transform lg:duration-0 absolute lg:static z-[9] left-0 lg:translate-y-0 ${isOpen ? 'translate-y-0' : '-translate-y-[102%]'}`}>
				<NavLink to={`/cv`}>
